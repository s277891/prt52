...
public class circulationproblem extends ListActivity{
    List circulationproblemlist = new ArrayList();
    Button btn_diabtes;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_circulationproblem);
        addcirulationlist();
        ArrayAdapter adapter=new ArrayAdapter(this,android.R.layout.simple_list_item_1, circulationproblemlist);
    ...
    private void addcirulationlist() {
        circulationproblemlist.add("Lowering BP");
        circulationproblemlist.add("Lowering Cholestrol");
        circulationproblemlist.add("Lowering Glucose Level");
        circulationproblemlist.add("Stop Smoking");
        circulationproblemlist.add("Reduce Waist");
        circulationproblemlist.add("Increase Physical");
        circulationproblemlist.add("Better Food Choice");
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_circulationproblem, menu);
        return true;
    }
