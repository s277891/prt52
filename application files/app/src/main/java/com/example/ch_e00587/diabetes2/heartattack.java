...
public class heartattack extends ListActivity{
    ...
    private void addcirulationlist() {
        ...
        strokeslist.add("Reduce Waist");
        strokeslist.add("Taking Aspirin");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_heartattack, menu);
        return true;
    }
